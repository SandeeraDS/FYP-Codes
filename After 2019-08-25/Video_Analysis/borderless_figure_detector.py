...
# method - get point to crop around the figure
def get_main_points(hor_lines, ver_lines, vis):
    final_box = []
...
class figure_detector_borderless:
    ...
    # create object of border figure detector class
    ...
    def figure_detection_borderless(self, gray_img, binary_img, frame_position, time_stamp):
        ...
        # method call
        [min_x, min_y, max_x, max_y] = get_main_points(hor_lines, ver_lines, gray_img)
